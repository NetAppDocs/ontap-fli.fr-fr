...
summary: 'La matrice d"interopérabilité FLI (IMT) est un outil d"interopérabilité distinct conçu pour mieux prendre en charge les baies sources qualifiées NetApp qui fonctionnent avec FLI.' 
---
...
[role="lead"]
La matrice d'interopérabilité FLI (IMT) est un outil d'interopérabilité distinct conçu pour mieux prendre en charge les baies sources qualifiées NetApp qui fonctionnent avec FLI.
