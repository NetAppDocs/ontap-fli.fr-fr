...
summary: 'Les baies de stockage utilisées lors de la migration doivent avoir un chemin principal depuis chaque contrôleur (en service) présent dans les deux infrastructures. Cela signifie que les nœuds de la baie source et de la baie de destination vers lesquelles la migration est effectuée doivent se trouver dans une zone commune sur les deux infrastructures.' 
---
