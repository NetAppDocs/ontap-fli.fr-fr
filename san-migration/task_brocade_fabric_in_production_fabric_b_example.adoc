...
summary: Voici un exemple de structure Brocade dans le fabric de production B. 
---
= Exemple de structure Brocade dans le fabric de production B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Voici un exemple de structure Brocade dans le fabric de production B
